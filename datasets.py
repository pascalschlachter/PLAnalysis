...
class DatasetWithIDs(torch.utils.data.Dataset):
    def __init__(self, dataset):
        ...
        self.ids     = list(range(len(dataset)))  # Generate unique IDs for each sample
...
class SFUniDADataModuleBase(L.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        # add unique ids for each sample
        self.train_set = DatasetWithIDs(self.train_set)
        self.test_set  = DatasetWithIDs(self.test_set)
